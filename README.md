...
### v0.2.0 (当前版本) （Q群内侧）- 2025/01/08
**🎯 重大更新：解决全屏游戏置顶问题**

#### ✨ 新功能
- 🔝 **UIAccess高级置顶**：新增C++模块`high_priority_topmost`，支持在全屏游戏中保持浏览器窗口置顶
- 🎮 **全屏游戏兼容**：解决了原神等全屏游戏中浏览器窗口无法置顶的问题

#### 🔧 技术改进
- ⚡ **模块化设计**：将快捷键和置顶功能分离为独立的C++模块
- 🔒 **UTF-8编码支持**：修复中文窗口标题识别问题
- 🎯 **精确窗口控制**：确保只有浏览器窗口置顶，主窗口永不置顶
- 🏗️ **构建优化**：修复版本号格式，禁用代码签名，支持便携式打包
...
```
新增文件：
├── src/native/src/high_priority_topmost.cc  # 高级置顶C++模块
├── src/native/lib/topmost.js                # 置顶模块JS封装

修改文件：
├── src/native/binding.gyp                   # 新增topmost模块构建配置
├── src/native/package.json                  # 更新模块名和版本
├── src/main/main.js                         # 集成置顶功能和窗口管理
├── package.json                            # 版本更新和构建配置
```
---
